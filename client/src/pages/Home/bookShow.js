        ...
        return (
            <div className="d-flex flex-column align-items-center">
                <div className="w-100 max-width-600 mx-auto mb-25px">
                    <p className="text-centre mb-10px">
                        ...
                        >
                            {getSeats()} {/* Rendering dynamic seat layout */
                             selectedSeats.length>0&&(
                                ...
                                stripeKey="pk_test_51Qk3GLBy7Xvj8UmLTg7Ks5pTGhnfzfg5Psk20pCUhA1TuUMXPNyU9vZYQp5cbGf42QkDWHZrhMQGnAMZOk9JtOKf00APXMzYSg"
                                >
                                {/*Usethisoneinsomesituation=>
